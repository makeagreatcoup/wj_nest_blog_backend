...
import { ApiConfig } from '../restful/type';

import { Configure } from './configure';
import { createBootModule, panic } from './helpers';
import { ConfigStorageOption, CreateOptions, CreatorData } from './type';
