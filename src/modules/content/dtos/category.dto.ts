...
import { IsEnum, IsNotEmpty, IsNumber, IsOptional, IsUUID, MaxLength, Min, ValidateIf } from "class-validator";
...
export class CreateCategoryDto {
  ...
  @MaxLength(25,{always:true,message:'分类名称长度不能超过$constraint1'})
